...
- (void)awakeFromNib
{
//    [self.tableView registerClass:[CounselorCell class] forCellReuseIdentifier:conselorCellReuseID];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:conselorCellReuseID forIndexPath:indexPath];
